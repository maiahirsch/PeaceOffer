...
#include <Wire.h> //I2C communication. Allows multiple devices to communicate using SDA(to send data) and SCL (to synchronize communcation)
...
Adafruit_PWMServoDriver pwm = Adafruit_PWMServoDriver(); //creates an instant (pwm) allowing communication with the PWM servo driver and control the 16PWM channels.
